package com.jd.ad.anti.utils.implicits

import java.nio.charset.{Charset, StandardCharsets}

import com.jd.ad.anti.utils.parsers.{Arguments, ArgumentsParser}
...
case class StringImplicitor(@transient str : String) extends SimpleSpark{
  ...
  /**
    ...
    * @return
    */
  def runSql: DataFrame = spark sql str

  /**
    * easy way to fetch data of a table or a view
    * @return
    */
  def fetchAll: DataFrame = s"select * from $str" runSql
